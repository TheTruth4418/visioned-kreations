    ...
    return (
        <div className="item-container">
            ...
            <div className="item-options">
                ...
                {this.state.size ? (this.inventoryReader(this.state.size).stock !== 0 ? <> <p className="stock">In Stock</p> <p>Price ${this.inventoryReader(this.state.size).price}</p> <button onClick={this.submitCart}>Add to Cart</button> </> : <p>Out of Stock</p>) : <p>Select a size</p>}
            </div>
